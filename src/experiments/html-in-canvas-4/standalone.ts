// ============================================================
// html-in-canvas 4 — Standalone IIFE entry for Webflow export
// WebGL2 + html-in-canvas beta API, zero React dependencies
// ============================================================
...
(function () {
  const wrapper = document.querySelector(
    '[data-webgl-experiment="html-in-canvas-4"]',
  );
  if (!wrapper) return;
  ...
  // Text texture — initialize with 1x1 placeholder
  ...
  const handlePaint = () => {
    ...
    try {
      ...
      console.warn('[html-in-canvas-4] texElementImage2D:', e);
    }
    pendingPaint = false;
  };
  ...
  function render() {
    ...
    if (!textureReady) {
      const tick = Math.floor(accTime * 4.0);
    ...
    gl!.uniform1f(uGlitchIntensity, BP.glitchIntensity as number);
