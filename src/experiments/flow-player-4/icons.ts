// ============================================================
// Inline SVG icons for the control bar. All SVGs use
// fill="currentColor" so the parent's CSS color drives them —
// that's how the accent variable propagates.
...
// Big centered play button shown on the slot before playback.
// Triangle uses fill="currentColor" so the slot's --vp-accent
// cascades through. Centroid lands on viewBox center for visual balance.
