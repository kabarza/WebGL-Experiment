  ...
  const folderContent = /* @__PURE__ */ jsxs("div", { ref: isRoot ? contentRef : void 0, className: `dialkit-folder ${isRoot ? "dialkit-folder-root" : ""}`, children: [
    ...
    /* @__PURE__ */ jsx(AnimatePresence, { initial: false, children: isOpen && /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "dialkit-folder-inner", style: isRoot ? { paddingBottom: 0 } : void 0, children })
      }
    ) })
  ] });
  if (isRoot) {
    ...
    const panelStyle = isOpen ? { width: 280, height: contentHeight !== void 0 ? contentHeight + 12 : "auto", borderRadius: 14, boxShadow: "0 8px 32px rgba(0, 0, 0, 0.5)", cursor: void 0 } : { width: 42, height: 42, borderRadius: 21, boxShadow: "0 4px 16px rgba(0, 0, 0, 0.25)", overflow: "hidden", cursor: "pointer" };
    return /* @__PURE__ */ jsx(
      motion.div,
      {
