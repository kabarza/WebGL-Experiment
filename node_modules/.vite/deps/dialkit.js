...
function LiquidToggle({ label, value, onChange }) {
  var thumbRef = (0, import_react20.useRef)(null);
...
Apply these values as the new defaults in the useDialKit call.`;
  ...
  const renderControl = (control) => {
    ...
    switch (control.type) {
      ...
      case "ub-toggle":
        return (0, import_jsx_runtime16.jsx)(LiquidToggle, { label: control.label, value, onChange: (v) => DialStore.updateValue(panel.id, control.path, v) }, control.path);
      default:
        return null;
    }
  };
