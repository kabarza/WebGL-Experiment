    ...
    return (0, import_jsx_runtime14.jsx)("div", { ref: wrapperRef, className: "dialkit-slider-wrapper", children: (0, import_jsx_runtime14.jsxs)(
      motion.div,
      {
        ...
        children: [
          ...
          editing ? mkInput() : (0, import_jsx_runtime14.jsx)("span", { ref: valueRef, className: "dialkit-slider-value", onClick: startEdit, onPointerDown: (e) => e.stopPropagation(), onMouseDown: (e) => e.stopPropagation(), children: display })
        ]
      }
    ) });
  }
  if (variant === "ub-2" || variant === "ub-5") {
    ...
    return (0, import_jsx_runtime14.jsxs)("div", {
      ...
      children: [
        ...
        (0, import_jsx_runtime14.jsx)("span", { ref: labelRef, className: "dialkit-slider-label", children: label }),
        editing ? mkInput() : (0, import_jsx_runtime14.jsx)("span", { ref: valueRef, className: "dialkit-slider-value", onClick: startEdit, onPointerDown: (e) => e.stopPropagation(), children: display })
      ]
    });
  }
...
Apply these values as the new defaults in the useDialKit call.`;
  ...
  const renderControl = (control) => {
    ...
    switch (control.type) {
      ...
      case "folder":
        return (0, import_jsx_runtime15.jsx)(Folder, { title: control.label, defaultOpen: control.defaultOpen ?? true, children: (_a2 = control.children) == null ? void 0 : _a2.map(renderControl) }, control.path);
      case "text":
        return (0, import_jsx_runtime15.jsx)(
          TextControl,
          {
      ...
      case "ub-7":
      case "ub-8":
        return (0, import_jsx_runtime15.jsx)(UBControl, { variant: control.type, label: control.label, value, step: control.step ?? 1, onChange: (v) => DialStore.updateValue(panel.id, control.path, v) }, control.path);
      default:
        return null;
    }
  };
  ...
  const toolbar = (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
    (0, import_jsx_runtime15.jsx)(
      motion.button,
      {
        ...
        whileTap: { scale: 0.9 },
        transition: { type: "spring", visualDuration: 0.15, bounce: 0.3 },
        children: (0, import_jsx_runtime15.jsx)("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: ICON_ADD_PRESET.map((d, i) => (0, import_jsx_runtime15.jsx)("path", { d }, i)) })
      }
    ),
    (0, import_jsx_runtime15.jsx)(
      PresetManager,
    ...
    (0, import_jsx_runtime15.jsx)(
      motion.button,
      {
        ...
        whileTap: { scale: 0.9 },
        transition: { type: "spring", visualDuration: 0.15, bounce: 0.3 },
        children: (0, import_jsx_runtime15.jsx)("span", { style: { position: "relative", width: 16, height: 16 }, children: (0, import_jsx_runtime15.jsx)(AnimatePresence, { initial: false, mode: "wait", children: copied ? (0, import_jsx_runtime15.jsx)(
          motion.svg,
          {
            viewBox: "0 0 24 24",
            fill: "none",
            ...
            children: (0, import_jsx_runtime15.jsx)("path", { d: ICON_CHECK })
          },
          "check"
          ...
          motion.svg,
          {
            ...
            transition: { duration: 0.08 },
            children: [
              (0, import_jsx_runtime15.jsx)("path", { d: ICON_CLIPBOARD.board, stroke: "currentColor", strokeWidth: "2", strokeLinejoin: "round" }),
              (0, import_jsx_runtime15.jsx)("path", { d: ICON_CLIPBOARD.sparkle, fill: "currentColor" }),
              (0, import_jsx_runtime15.jsx)("path", { d: ICON_CLIPBOARD.body, stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
            ]
          },
          "clipboard"
        ) }) })
  ...
  return (0, import_jsx_runtime15.jsx)("div", { className: "dialkit-panel-wrapper", children: (0, import_jsx_runtime15.jsx)(Folder, { title: panel.name, defaultOpen, isRoot: true, inline, onOpenChange: setIsPanelOpen, toolbar, children: renderControls() }) });
}
var _a;
...
function DialRoot({ position = "top-right", defaultOpen = true, mode = "popover", theme = "system", productionEnabled = isDevDefault }) {
  ...
  const content = (0, import_jsx_runtime16.jsx)(ShortcutListener, { children: (0, import_jsx_runtime16.jsx)("div", { className: "dialkit-root", "data-mode": mode, "data-theme": theme, children: (0, import_jsx_runtime16.jsx)(
    "div",
    {
      ref: panelRef,
      ...
      children: panels.map((panel) => (0, import_jsx_runtime16.jsx)(Panel, { panel, defaultOpen: inline || defaultOpen, inline }, panel.id))
    }
  ) }) });
  if (inline) {
    return content;
...
function ButtonGroup({ buttons }) {
  return (0, import_jsx_runtime17.jsx)("div", { className: "dialkit-button-group", children: buttons.map((button, index) => (0, import_jsx_runtime17.jsx)(
    "button",
    {
      className: "dialkit-button",
...
function ShortcutsMenu({ panelId }) {
  ...
  const [pos, setPos] = (0, import_react20.useState)({ top: 0, right: 0 });
  ...
  return (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
    (0, import_jsx_runtime18.jsx)(
      motion.button,
      {
        ...
        whileTap: { scale: 0.9 },
        transition: { type: "spring", visualDuration: 0.15, bounce: 0.3 },
        children: (0, import_jsx_runtime18.jsxs)("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
          (0, import_jsx_runtime18.jsx)("rect", { x: "2", y: "6", width: "20", height: "12", rx: "2" }),
          (0, import_jsx_runtime18.jsx)("path", { d: "M6 10H6.01" }),
          (0, import_jsx_runtime18.jsx)("path", { d: "M10 10H10.01" }),
          (0, import_jsx_runtime18.jsx)("path", { d: "M14 10H14.01" }),
          (0, import_jsx_runtime18.jsx)("path", { d: "M18 10H18.01" }),
          (0, import_jsx_runtime18.jsx)("path", { d: "M8 14H16" })
        ] })
      }
    ),
    (0, import_react_dom4.createPortal)(
      (0, import_jsx_runtime18.jsx)(AnimatePresence, { children: isOpen && (0, import_jsx_runtime18.jsxs)(
        motion.div,
        {
          ref: dropdownRef,
          ...
          transition: { type: "spring", visualDuration: 0.15, bounce: 0 },
          children: [
            (0, import_jsx_runtime18.jsx)("div", { className: "dialkit-shortcuts-title", children: "Keyboard Shortcuts" }),
            (0, import_jsx_runtime18.jsx)("div", { className: "dialkit-shortcuts-list", children: rows.map((row) => (0, import_jsx_runtime18.jsxs)("div", { className: "dialkit-shortcuts-row", children: [
              (0, import_jsx_runtime18.jsx)("span", { className: "dialkit-shortcuts-row-key", children: formatShortcutKey(row.shortcut) }),
              (0, import_jsx_runtime18.jsx)("span", { className: "dialkit-shortcuts-row-label", children: row.label }),
              (0, import_jsx_runtime18.jsx)("span", { className: "dialkit-shortcuts-row-mode", children: formatInteraction(row.shortcut) })
            ] }, row.path)) }),
            (0, import_jsx_runtime18.jsx)("div", { className: "dialkit-shortcuts-hint", children: "See pill badges on controls for keys" })
          ]
        }
      ) }),
      document.body
